...
from pie.models import BaseModel, SimpleModel
from pie.data.dataset import Dataset, MultiLabelEncoder


m = BaseModel.load("../latin-lasla-models/lasla.tar")
settings = m._settings  # copy.copy(m._settings)

settings["input_path"] = "/home/thibault/dev/latin-non-classical-data/lasla-model-ready/Augustin --  De civitate Dei.tsv"
settings["dev_path"] = "/home/thibault/dev/latin-non-classical-data/lasla-model-ready/Ammien Marcellin --  Res gestae.tsv"
